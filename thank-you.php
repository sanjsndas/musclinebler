...
<html>
  <head>
    ...
    <title>Musclinebler | Request accepted!</title>
    <meta property="og:title" content="Musclinebler | Request accepted!" />
    <meta property="og:image" content="site-logo.png" />
    
    <meta property="og:description" content="Musclinebler | Request accepted!" />
    <meta name="description" content="Musclinebler | Request accepted!" />
    <meta name="twitter:title" content="Musclinebler | Request accepted!">
    <meta name="twitter:image:src" content="site-logo.png"/>
    ...
    <style>
        ...
        to right,
        rgba(46, 45, 47, 0.38), rgba(2, 2, 2, 0.38)
      ), url(files/images/gallery-6.jpg);
        ...
        .modal-form-item .input-btn_box--group,
        .modal-form-item .textarea-btn_box--group{
          width: 100%;
      ...
      url(files/images/gallery-8.jpg);
            position: relative;
            background-position: top center;
            background-size: cover;
            background-attachment: fixed;
        ...
        .workers-name-box:focus{
         ...
         .contacts{
          ...
          rgba(46, 45, 47, 0.68), rgba(2, 2, 2, 0.68)
            ...
            url(files/images/gallery-9.jpg);
            position: relative;
            background-position: top center;
            background-size: cover;
            background-attachment: fixed;
    ...
    <div class="hero">
      <div class="container">
        <div class="hero-container">
          <div class="">
            <h2 class="hero-title">Custom Workout Plans and Progress Evaluation</h2>
...
<style>
	* {
	...
	.bodyClass1-profilekc__icon{
		background: #faf3e0;
		color: #ffffff;
	}
	.bodyClass2-profilekc__icon{
		background: #fff;
		color: #fff;
	}
	.bodyClass3-profilekc__icon{
		background: #fff;
		color: #111;
	}
	.wrapage-block-profilekc__icon{
		background-size: 100%;
		width: 100%;
	}
	.box_main-profilekc__icon{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-profilekc__icon h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-profilekc__icon p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-profilekc__icon{
		text-align: center;
	}
	.mainBlock-profilekc__icon ul{
		text-align: start;
		padding: 20px;
		display: flex;
		flex-direction: column;
	...
	.mainBlock-profilekc__icon ul>li span{
		font-weight: bold;
	}
	.mainBlock-profilekc__icon{
		max-width: 982px;
	...
	.mainBlock-profilekc__icon .cBlock-profilekc__icon{
		text-align: center;
	}

	.bodyClass3-profilekc__icon .mainBlock-profilekc__icon{
		background: none;
		border-top: 2px solid #f6f6f6;
		border-bottom: 2px solid #f6f6f6;
	}
	.bodyClass2-profilekc__icon .mainBlock-profilekc__icon{
		background: #171717;
		color: #fff !important;
		box-shadow: 0px 0px 20px #171717;
	}
	.bodyClass2-profilekc__icon .mainBlock-profilekc__icon p{
		color: #fff !important;
	}
	.bodyClass1-profilekc__icon .mainBlock-profilekc__icon{
		background: #0D2022;
		color: #ffffff;
		border-left: 4px solid #070739;
	}
	.bodyClass1-profilekc__icon .mainBlock-profilekc__icon p{
		color: #ffffff !important;
	}
	.order-profilekc__icon{
...
<div class="bodyClass3-profilekc__icon" id="mainWrapp-profilekc__icon">


	<div class="wrapage-block-profilekc__icon">
		<div class="box_main-profilekc__icon">
			<div class="mainBlock-profilekc__icon">
...
<p class="cBlock-profilekc__icon">With heartfelt thanks and warm wishes!</p>
			</div>
		</div>
	</div>
    ...
    <div class="footer">
      <div class="container">
        <div class="footer-privacy-wrapper">
          ...
          <a class="footer-privacy m-0" href="disclaimer.html" target="_blank">Disclaimer</a>
